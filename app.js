...
const demoAccessCards = [registeredUsers.find(user => user.profile === "Vendedor"), registeredUsers.find(user => user.profile === "Liderança"), ...registeredUsers.filter(user => user.profile === "Administrador")].filter(Boolean);
const focusProducts = [{
  id: "qualiz-18",
  sku: "10001",
...
function LoginScreen({
  ...
  }, "Acesso controlado • Ambiente de demonstração")), /*#__PURE__*/React.createElement("section", {
  ...
  }, "Use seu CPF e senha de acesso."), /*#__PURE__*/React.createElement("form", {
    onSubmit: submit,
  ...
  }, "Acessos para demonstração"), /*#__PURE__*/React.createElement("div", {
    className: "mt-3 grid gap-2 text-[11px]"
  }, demoAccessCards.map(user => /*#__PURE__*/React.createElement("button", {
    type: "button",
    key: user.cpf,
    onClick: () => {
      setCpf(user.cpf);
      setPassword("potiguar2026");
      setError("");
    },
    className: "flex justify-between rounded-lg bg-white px-3 py-2 text-left font-bold text-potiguar-800"
  }, /*#__PURE__*/React.createElement("span", null, user.cpf), /*#__PURE__*/React.createElement("span", {
    className: "text-slate-400"
  }, user.profile)))), /*#__PURE__*/React.createElement("p", {
    className: "mt-3 text-[10px] text-slate-400"
  }, "Senha para todos: ", /*#__PURE__*/React.createElement("strong", null, "potiguar2026"))))));
}
function Sidebar({
  page,
  setPage,
...
function Avatar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `${cls} grid place-items-center rounded-full border-2 border-white/70 bg-gradient-to-br from-potiguar-lime to-potiguar-yellow font-extrabold text-potiguar-950 shadow-sm`
...
function ProductCard({
  ...
  }, leadership ? `Desempenho consolidado da equipe ${user.store}` : `Todos os vendedores competem em igualdade • Marca ${focus.product.brand}`), /*#__PURE__*/React.createElement("div", {
    className: "mt-6"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, focus.sold, " ", /*#__PURE__*/React.createElement("small", {
  ...
  }, leadership ? "Sua pontuação depende do resultado desta equipe." : focus.remaining > 0 ? `Faltam só ${focus.remaining} ${unit} para bater a meta!` : "Meta batida! Agora é ampliar a vantagem."))), /*#__PURE__*/React.createElement("div", {
...
function Announcement({
  ...
  }, "Novo processo de frete no Visual Store")), /*#__PURE__*/React.createElement("span", {
  ...
  }, "A partir de hoje, toda cotação de frete deve ser realizada pelo simulador disponível dentro do Visual Store. Antes de concluir a venda, informe corretamente o CEP, confira as opções de entrega, o prazo e o valor apresentado. Não utilize cálculos ou valores de frete feitos fora do sistema."), /*#__PURE__*/React.createElement("div", {
    className: "mt-4 rounded-xl border border-amber-100 bg-amber-50 p-3 text-xs leading-5 text-amber-800"
  }, /*#__PURE__*/React.createElement("strong", {
    className: "block font-extrabold"
  }, "Novo fluxo obrigatório"), "Visual Store → Simulador de Frete → Informar CEP → Selecionar entrega → Confirmar na venda."), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Vídeo do processo"), /*#__PURE__*/React.createElement("p", {
    className: "mt-0.5 text-xs font-semibold text-white/65"
  }, "Assista ao passo a passo no Visual Store")), /*#__PURE__*/React.createElement("span", {
...
function MiniRanking() {
  ...
  }, ranking.slice(0, 3).map((person, idx) => /*#__PURE__*/React.createElement("div", {
    key: person.name,
    className: "flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("span", {
...
function StoreMiniRanking({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-[10px] text-slate-400"
    }, "Vendedor")), /*#__PURE__*/React.createElement("strong", {
      className: "font-display text-lg text-potiguar-900"
    }, person.points));
  })));
}
function Home({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-sm font-extrabold text-potiguar-950"
  }, user.store, " • ", leadership ? `${storeStats.networkPosition}ª loja da rede` : `${user.position || "—"}º geral`)))), /*#__PURE__*/React.createElement("div", {
    ...
    icon: "ranking",
    label: leadership ? "Posição da loja" : "Posição geral",
    value: leadership ? `${storeStats.networkPosition}º` : `${user.position || "—"}º`,
    detail: leadership ? `${storeStats.percent}% da meta` : "Acompanhe sua loja abaixo",
    accent: "lime"
  }), /*#__PURE__*/React.createElement(StatCard, {
    icon: "target",
    ...
    user: user
  }), /*#__PURE__*/React.createElement(MiniRanking, null)), /*#__PURE__*/React.createElement("div", {
    className: "grid gap-6 xl:grid-cols-[1.45fr_.8fr]"
    ...
    name: "chevron"
  }))))), user.accessRole === "seller" && /*#__PURE__*/React.createElement(StoreMiniRanking, {
    user: user
  }));
}
function Guesses({
...
function RankingPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, person.role, " • ", person.store || user.store)), person.trend && /*#__PURE__*/React.createElement("span", {
...
function StorePage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "mt-2 text-sm text-white/60"
  }, storeStats.networkPosition, "ª colocada no ranking da rede • ", storeStats.score, " pontos")), /*#__PURE__*/React.createElement("div", {
  ...
  }, storeStats.percent, "%"))), /*#__PURE__*/React.createElement("div", {
    className: "mt-7"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "h-full rounded-full bg-potiguar-lime",
    style: {
      width: `${Math.min(storeStats.percent, 100)}%`
    }
  })))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "rounded-full bg-potiguar-lime/25 px-3 py-1 text-[10px] font-extrabold text-potiguar-800"
  }, localRanking.length, " VENDEDORES")), /*#__PURE__*/React.createElement("div", {
    className: "mt-5 space-y-3"
    ...
    className: "truncate text-[10px] text-slate-400"
  }, p.role)), /*#__PURE__*/React.createElement("strong", {
    className: "font-display text-lg text-potiguar-900"
...
function AdminPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    icon: "users",
    label: "Usuários do piloto",
    value: users.length,
    detail: `${users.filter(u => u.profile === "Vendedor").length} vendedores • ${users.filter(u => u.profile === "Liderança").length} líderes`,
    accent: "green"
  }), /*#__PURE__*/React.createElement(StatCard, {
    icon: "megaphone",
    label: "Leituras",
    ...
    onClick: () => setToast(`${formModule.button}: demonstração registrada. A persistência será feita no PostgreSQL.`),
    className: "rounded-xl bg-potiguar-900 px-5 py-3 text-xs font-extrabold text-white"
